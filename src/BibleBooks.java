public class BibleBooks
{
	...
	public BibleBooks(String Bookname, int numberOfChapters, String summary)
	{
		//Initial objects
	...
	public BibleBooks(String commaDelimited)
	{
	...
	{
		//Prints out array
		System.out.printf("Name: %s Number of chapters: %d Summary: %s \n", this.Bookname, this.numberOfChapters, this.summary);
	}
	//Returns Objects
